...
import { UserOutlined,ProductOutlined  ,EditOutlined ,HomeOutlined } from '@ant-design/icons';
import "./layout.css"
...
const SideBar = () => {
  ...
  return (
      ...
      <Menu defaultSelectedKeys={["1"]} style={{
        ...
        <Menu.Item onClick={() => navigate("managepost")} key={"4"} icon={<EditOutlined />}>Quản lí bài viết </Menu.Item>
      </Menu>
